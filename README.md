...
**当前 `main` 不是我最新验证过的自定义稳定版本。**

- 如果你只是偶然打开这个仓库，请不要默认把 `main` 当成“已经验证可直接构建和长期使用”的版本
- 我自己最近一次明确保存的稳定版本在分支 `stable-2026-05-23`
- 对应的稳定标签是 `stable-audio-ok-2026-05-23`
- 如果你想参考我最近一次确认能继续开发和回退的版本，优先查看上述稳定分支或标签，而不是直接依赖 `main`
