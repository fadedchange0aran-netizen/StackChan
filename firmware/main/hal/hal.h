...
public:
    ...
    bool isXiaozhiRunning() const
    {
        return _xiaozhi_running;
    }
    bool isNativeModePreferred();
    void setNativeModePreferred(bool preferred);
    void startXiaozhi();
    void startVpsBridgeIfNeeded();
...
private:
    ...
    bool _xiaozhi_running         = false;
    bool _vps_bridge_started      = false;
